    ...
    <div class="d-flex">
        <nav class="flex-column bg-primary text-white vh-100 p-3" style="width:250px;">
            ...
            <ul class="nav nav-pills flex-column">
                ...
                <?php } elseif ($level == "2") { ?>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="dashboard.php">Dashboard</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="catalog.php">Product Catalog</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="cart.php">Cart</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="wishlist.php">Wishlist</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="orders.php">Orders</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="addresses.php">Saved Addresses</a></li>
                    <li class="nav-item mt-auto"><a class="nav-link text-white" onclick="return confirm('Are you sure you want to logout?');" href="logout.php">Logout</a></li>
                <?php } ?>
            </ul>
        </nav>
